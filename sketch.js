var trex, trex_running, trex_collided, obstacle, obstacle2, obstacle3, obstacle4, obstacle5, obstacle6;
var ground, invisibleGround, groundImage, cloudImage, cloudGroup, obstaclesGroup, score;
...
function spawnObstacles(){
  ...
  if(frameCount%60===0){
    ...
    var cactus = createSprite(600,165,20,20);
    cactus.velocityX = -5;
    cactus.lifetime = 120;
    cactus.scale = 0.5
